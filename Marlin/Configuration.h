...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 94.50
  #define DEFAULT_bedKi 15.55
  #define DEFAULT_bedKd 382.96
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, 0 }  // PETSFANG offset, adjust Z-axis at runtime
